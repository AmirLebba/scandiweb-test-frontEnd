...
export default function ProductPage() {
  ...
  const { selectedImage, setSelectedImage, setSelectedAttributes } =
    useAppContext();
      ...
      <div className="product-modal">
        <div className="product-gallery" data-testid="product-gallery">
          ...
          <div className="gallery-main">
            <button className="prev" onClick={() => handleImageChange(-1)}>
              ❮
            </button>
            {selectedImage ? (
            ...
            <button className="next" onClick={() => handleImageChange(1)}>
              ❯
            </button>
          </div>
        </div>
